...
st.write("Produksi Maksimum Tahun ke-{}".format(T))
st.write(df_maks[df_maks["tahun"]==T])
st.write("Tnformasi Produksi Maksimal per Tahun")
st.write(df_maks)
st.write("Produksi Minimum (Bukan Nol) Tahun ke-{}".format(T))
st.write(df_min[df_min["tahun"]==T])
st.write("TInformasi Minimum (Bukan Nol) per Tahun")
st.write(df_min)
st.write("Produksi Nol Tahun ke-{}".format(T))
st.write(df_nol[df_nol["tahun"]==T])
st.write("Informasi Produksi Nol per Tahun")
st.write(df_nol)
